...
10. 用`X5WebView`进行H5页面加载
11. 用`Bugly`进行崩溃上报
12. 用`Splashscreen API`作为首屏加载
13. 用`build-logic`来代替`buildSrc`作为构建（来自Google官方的 [nowinandroid](https://github.com/android/nowinandroid)）
14. 用`Coroutines`+`Flow`来代替`RxJava`进行异步操作
